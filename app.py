...
app.config['UPLOAD_FOLDER'] = str(PROJECT_DIR / 'static' / 'uploads')
...
encoder = VGGEncoder(str(PROJECT_DIR / 'vgg_normalised.pth')).to(device)
decoder = Decoder().to(device)
decoder.load_state_dict(torch.load(PROJECT_DIR / 'experiment' / 'final_exp' / 'decoder_final.pth', map_location=device))
...
def send_example(filename):
    return send_from_directory(PROJECT_DIR / 'examples', filename)
