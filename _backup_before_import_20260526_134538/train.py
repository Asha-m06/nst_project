...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=str(project_dir / 'content_data'),
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=str(project_dir / 'style_data'),
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=str(project_dir / 'vgg_normalised.pth'),
